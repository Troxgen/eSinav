...
<div class="row">
  ...
  <div class="col-lg-4 col-md-6">
    <div class="card info-card sales-card">
      <div class="card-body">
        <h5 class="card-title">Apartman Adet</h5>
        <div class="d-flex align-items-center">
          ...
          <div class="ps-3">
            <h6><?= $userCount ?></h6>
            <span class="text-primary small pt-1 fw-bold">Toplam Apartman Adeti</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-4 col-md-6">
    <div class="card info-card revenue-card">
      <div class="card-body">
        <h5 class="card-title">Alınmış Ödemeler <span>| Ay</span></h5>
        <div class="d-flex align-items-center">
          <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
          ...
          <div class="ps-3">
            <h6><?= $paid ?></h6>
            <span class="text-success small pt-1 fw-bold">Bu Ay elde edilen toplam kazanç </span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-4 col-md-6">
    <div class="card info-card customers-card">
      <div class="card-body">
        <h5 class="card-title">Ödenmemş Ödemeler <span>| Ay</span></h5>
        <div class="d-flex align-items-center">
          <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
          ...
          <div class="ps-3">
            <h6><?= $pending ?></h6>
            <span class="text-warning small pt-1 fw-bold">Bekleyen Ödemeler Adedi</span>
          </div>
        </div>
      </div>
    </div>
